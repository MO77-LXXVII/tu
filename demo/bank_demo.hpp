...
void run_bank()
{
    ...
    nav.add(MenuID::main_menu, [&](tu::MenuNavigator<MenuID>& n)
    {
        return tu::Menu::create("Bank System")
                        ...
                        .add_item("Manage Clients", [&]{ n.push(MenuID::clients_menu);      }, [&] ()-> bool { return bank_user.has_any_client_permission(); })
                        .add_item("Manage Users",   [&]{ n.push(MenuID::users_menu);        }, [&] ()-> bool { return bank_user.has_any_user_permission();   })
                        .add_item("Transactions",   [&]{ n.push(MenuID::transaction_menu);  }, [&] ()-> bool { return bank_user.has_any_transaction_permission();   })
    ...
    nav.add(MenuID::transaction_menu, [&](tu::MenuNavigator<MenuID>& n)
    {
        return tu::Menu::create("Transactions")
            .add_item("Transfer", [&]{ n.push(MenuID::transfer_menu); }, perm(bank::Permission::Transfer))
            .add_item("History",  [&]{ n.push(MenuID::history_menu);  }, perm(bank::Permission::ViewHistory))
            .add_separator()
            .add_item("Back to Main", [&]{ n.pop(); });
    });
