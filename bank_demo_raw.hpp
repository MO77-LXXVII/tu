    ...
    while(!menu_stack.empty())
    {
        ...
        if(current == "main")
        {
            auto result = tu::Menu::create("Bank System")
                ...
                .add_item("Manage Clients", [&]{ menu_stack.push("clients");      }, perm(bank::Permission::ManageClients))
                .add_item("Manage Users",   [&]{ menu_stack.push("users");        }, perm(bank::Permission::ManageUsers))
