...
---
## Table of Contents
- [tu: Terminal Utilities](#tu-terminal-utilities)
  - [Table of Contents](#table-of-contents)
  - [Library Overview](#library-overview)
    - [Namespace Map](#namespace-map)
  - [Components](#components)
    - [Platform (`tu::platform`)](#platform-tuplatform)
      - [Key facilities:](#key-facilities)
    - [Menu System (`tu::Menu`, `tu::MenuNavigator`)](#menu-system-tumenu-tumenunavigator)
    - [Input (`tu::input`)](#input-tuinput)
    - [Output (`tu::output`)](#output-tuoutput)
    - [Colors and Styles (`tu::ColoredText`)](#colors-and-styles-tucoloredtext)
    - [Logger (`tu::logger`)](#logger-tulogger)
    - [Date (`utils::Date`)](#date-utilsdate)
    - [String Utilities (`stutl::String`)](#string-utilities-stutlstring)
...
| Role    | Description                                                                          |
| ------- | ------------------------------------------------------------------------------------ |
| Admin   | Full access to the system, including user management and data settings.              |
| Manager | Oversees transactions and user activities, with limited administrative capabilities. |
| Teller  | Limited access; mainly handles customer transactions and inquiries.                  |
